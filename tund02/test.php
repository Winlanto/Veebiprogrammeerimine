<?php
	...
	if($hourNow < 8 and $hourNow > 5){
		$partOfDay = "Varane hommik";
	}
	if($hourNow < 5 and $hourNow > 22){
		$partOfDay ="Öö";
	}
...
<html lang="et">
	...
	<body style="justify" bgcolor="#F2F4F4" alink="#808B96" background="https://images.pexels.com/photos/129731/pexels-photo-129731.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500">
